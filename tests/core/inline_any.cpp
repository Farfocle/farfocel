...
TEST_CASE("InlineAny - struct payload") {
    ...
    CHECK(!any.is_nil());
    CHECK(any.cast_ref<InlineAnyPayload>().a == 1);
    CHECK(any.cast_ref<InlineAnyPayload>().b == 2);
}
