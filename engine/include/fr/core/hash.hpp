...
struct Hash {
    ...
    static Hash from_raw(U64 n) noexcept {
        return Hash{.value = n};
    }
...
inline U64 splitmix_u64(U64 v) noexcept {
    v ^= v >> 30;
...
inline Hash hash(U32 v) noexcept {
    return Hash::from_raw(splitmix_u64(v));
}
...
inline Hash hash(S32 v) noexcept {
    return Hash::from_raw(splitmix_u64(static_cast<U64>(v)));
}
...
inline Hash hash(F32 v) noexcept {
    return Hash::from_raw(splitmix_u64(std::bit_cast<U32>(v)));
}

inline Hash hash(F64 v) noexcept {
    return Hash::from_raw(splitmix_u64(std::bit_cast<U64>(v)));
}
} // namespace fr
