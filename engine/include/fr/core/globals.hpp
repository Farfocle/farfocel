...
extern FR_API std::atomic<Alloc *> default_allocator;
/**
 * @brief Debug allocation call stack storage used by allocator instrumentation.
 */
extern FR_API std::atomic<AllocTracer *> allocation_stack;
 ...
 */
FR_API Alloc *get_malloc_allocator_untracked() noexcept;
 ...
 *
 * @param alloc New default allocator.
 * @return Previous default allocator.
 * @pre alloc is non-null.
 */
